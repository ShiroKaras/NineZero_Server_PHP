...
<head>
    ...
    <link rel="stylesheet" href="/Public/dist/admin-prop-list.css">
    <style>
    </style>
...
<div class="am-cf admin-main">
    ...
    <div ng-controller="AppCtrl">
        <div class="am-padding">
            <div simple-list ng-model="list" sdl-on="sdlOn" sdl-row-id="prop_id"  sdl-search-attrs="prop_name">
                ...
                <div class="am-g">
                    <div class="am-u-md-10 am-u-md-centered">
                        ...
                        <div sdl-template>
                            <div class="am-margin am-g sdl-item am-padding am-padding-bottom-xs" >
                                <div class="am-g">
                                    <div class="am-u-md-2">
                                        <figure data-am-widget="figure" class="am am-fr am-figure am-figure-default " data-am-figure="{  pureview: 'true' }">
                                            <img ng-src={{row.prop_pic}} alt="{{row.prop_name}}" class="am-img-responsive am-radius sdl-item-main-img">
                                        </figure>
                                        </div>
                                    <div class="am-u-md-10">
                                        <div class="am-cf sdl-item-header">
                                            <figure data-am-widget="figure" class="am am-fr am-figure am-figure-default " data-am-figure="{  pureview: 'true' }">
                                                <img ng-src="{{row.prop_gif}}" alt="" class="sdl-item-icon am-circle">
                                                <p class="am-text-center">gif图</p>
                                            </figure>
                                            <figure data-am-widget="figure" class="am am-fr am-figure am-figure-default" style="margin:0 12px;" data-am-figure="{  pureview: 'true' }">
                                                <img ng-src="{{row.prop_icon}}" alt="" class="sdl-item-icon am-circle">
                                                <p class="am-text-center">icon图</p>
                                            </figure>
                                            <p class="am-fl"><small class="am-badge am-badge-xs am-badge-primary">{{row.prop_id}}</small>{{row.prop_name}}</p>
                                        </div>
                                        <div class="am-divider am-divider-default"></div>
                                        <div ng-bind-html="row.prop_desc">
                                        </div>
                                ...
                                <a ng-href="/index.php?s=/Home/prop/save/prop_id/{{row.prop_id}}" class="am-btn am-btn-xs am-radius am-btn-success">编辑</a>
                                <span  class="am-btn am-btn-warning am-btn-xs am-radius" sdl-row-click="remove">删除</span>
                                </div>
                    ...
                    <div class="am-cf">
                            <span class="am-fl">共<span sdl-total-label></span>条 <span sdl-total-page></span>页 第<span sdl-page></span>页</span>
...
<script src="/Public/dist/admin-commons.js"></script>
    ...
    <script src="/Public/dist/admin-prop-list.js"></script>
