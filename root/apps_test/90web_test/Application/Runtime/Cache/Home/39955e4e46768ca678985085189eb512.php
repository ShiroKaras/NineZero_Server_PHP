                    ...
                    <div class="am-panel-bd">
                        <form class="am-form" method="post">
                            ...
                            <div class="am-margin am-text-right">
                                <button class="am-btn am-btn-success am-radius">推送</button>
                            </div>
                        </form>
                    </div>
                </div>
