...
<head>
    ...
    <link rel="stylesheet" href="/Public/dist/admin-pic-save.css">
    ...
    <div class="am-padding-lg">
        <div class="am-panel am-panel-default">
            <div class="am-panel-hd">
                <h3 class="am-panel-title"><i class="am-icon am-icon-file-text am-margin-right-sm"></i>图片管理</h3>
            </div>
                    ...
                    <div class="am-g">
                        <div class="am-u-sm-11">
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label">停赛日封面<span
                                        class="am-text-danger am-margin-left-xs">*</span></label>
                                <div class="am-u-sm-10">
                                    <input type="hidden" name="rest_cover" value="<?php echo ($data['rest_cover']); ?>" class="am-validate uploaded-img" required>
                                    <div>
                                        <?php if(isset($data['rest_cover'])): ?><img src="<?php echo ($data['rest_cover']); ?>" class="am-img-responsive upload-thumbnails" data-uploaded="true">
                                            <?php else: ?>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label">彩蛋图片<span
                                        class="am-text-danger am-margin-left-xs">*</span></label>
                                <div class="am-u-sm-10">
                                    <input type="hidden" name="pet_gif" value="<?php echo ($data['pet_gif']); ?>" class="am-validate uploaded-img" required>
                                    <div>
                                        <?php if(isset($data['pet_gif'])): ?><img src="<?php echo ($data['pet_gif']); ?>" class="am-img-responsive upload-thumbnails" data-uploaded="true">
                                            <?php else: ?>
                                            <img src="/Public/empty.png" class="am-img-responsive upload-thumbnails"><?php endif; ?>
                                    </div>
                                    <div class="am-margin-xs"></div>
...
<script src="/Public/dist/admin-commons.js"></script>
    ...
    <script src="/Public/dist/admin-pic-save.js"></script>
