...
<head>
    ...
    <link rel="stylesheet" href="/Public/dist/admin-pet-list.css">
    <style>
    </style>
...
<div class="am-cf admin-main">
    ...
    <div ng-controller="AppCtrl">
        <div class="am-padding">
            <div simple-list ng-model="list" sdl-on="sdlOn" sdl-row-id="pet_id" sdl-search-attrs="pet_name">
                    ...
                    <div class="am-u-md-10 am-u-md-centered">
                        ...
                        <div sdl-template>
                            <div class="am-margin am-g sdl-item am-padding am-padding-bottom-xs" ng-controller="ItemCtrl" ng-init="expanded = false">
                                <span ng-init="descUrl = '<?php echo U('Pet/desc');?>'"></span>
                                <div class="am-g" >
                                    <div class="am-u-md-2">
                                        <figure data-am-widget="figure" class="am am-fr am-figure am-figure-default " data-am-figure="{  pureview: 'true' }">
                                            <img ng-src={{row.pet_pic}} alt="{{row.pet_name}}" class="am-img-responsive am-radius sdl-item-main-img">
                                        </figure>
                                    </div>
                                    <div class="am-u-md-10">
                                        <div class="am-cf sdl-item-header">
                                            <figure data-am-widget="figure"
                                                    class="am am-fr am-figure am-figure-default "
                                                    data-am-figure="{  pureview: 'true' }">
                                                <img ng-src="{{row.pet_gif}}" alt="{{row.pet_name}}" class="sdl-item-icon am-circle">
                                            </figure>
                                            <p class="am-fl">
                                                <small class="am-badge am-badge-xs am-badge-primary">{{row.pet_id}}
                                                </small>
                                                {{row.pet_name}}
                                            </p>
                                        </div>
                                        <div ng-show="expaned" class="am-divider am-divider-default"></div>
                                        <div ng-show="expaned">
                                            <div ng-bind-html="row.pet_desc"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="am-divider am-divider-default"></div>
                                <div class="sdl-item-actions am-text-right">
                                    <span class="am-btn am-btn-warning am-btn-xs am-radius" ng-click="expand()">{{!expaned ? "展开" : "收起"}}详情</span>
                                    <a ng-href="{{row.editUrl}}"
                                       class="am-btn am-btn-xs am-radius am-btn-success">编辑</a>
                                       <a ng-href="{{row.articleUrl}}"
                                          class="am-btn am-btn-xs am-radius am-btn-success">查看文章</a>
                                    <span class="am-btn am-btn-warning am-btn-xs am-radius"
...
<script src="/Public/dist/admin-commons.js"></script>
    ...
    <script src="/Public/dist/admin-pet-list.js"></script>
