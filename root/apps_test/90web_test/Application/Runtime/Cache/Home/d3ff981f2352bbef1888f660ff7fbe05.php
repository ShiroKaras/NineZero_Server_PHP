...
<head>
    ...
    <link rel="stylesheet" href="/Public/dist/admin-exchange-list.css">
    <style>
         table .op-col .comfirmed-text, table .op-col.active .comfirm-btn{
            display: none;
        }
        table .op-col .comfirm-btn, table .op-col.active .comfirmed-text{
           display: initial;
       }
    </style>
            ...
            <div class="am-u-sm-12">
                <table class="am-table am-table-bordered am-table-bd am-table-striped am-table-hover">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$tr): ?><tr>
                            ...
                            <td><?php echo ($tr["user_mobile"]); ?></td>
                            <td><?php echo ($tr["address"]); ?></td>
                            <td><?php echo ($tr["mobile"]); ?></td>
                            <td><?php echo ($tr["prop_name"]); ?></td>
                            <td>
                                <?php echo ($tr["time"]); ?>
                            </td>
                            <td>
                                <div class="op-col <?php echo ($tr['status'] == '1' ? 'active' : ''); ?>" status="">
                                    <a href="###" class="comfirm-btn" data-userid="<?php echo ($tr["user_id"]); ?>" data-propid="<?php echo ($tr["prop_id"]); ?>" data-url="<?php echo U('exchange/comfirm');?>">确认配送</a>
                                    <a class="comfirmed-text">已配送</a>
                                </div>
                            </td>
...
<script src="/Public/dist/admin-commons.js"></script>
    ...
    <script src="/Public/dist/admin-exchange-list.js"></script>
